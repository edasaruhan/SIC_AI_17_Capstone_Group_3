...
.\.venv\Scripts\python.exe -m pytest --cov=argus --cov-report=term-missing --cov-fail-under=75
...
Demo vaka içeriğinin provenance sözleşmesi otomatik testlerle, lint ve en az `%75` coverage
